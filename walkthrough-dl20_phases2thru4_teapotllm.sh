...
python -O -m exam_pp.exam_grading_tp data/dl20/$ungraded -o data/dl20/$withrate --model-pipeline text2text --model-name teapotai/teapotllm --prompt-class NuggetSelfRatedPrompt --question-path data/dl20/dl20-nuggets.jsonl.gz  --question-type question-bank --use-nuggets  

echo -e "\n\n\ Explained DL20 Nuggets"

python -O -m exam_pp.exam_grading_tp data/dl20/$withrate  -o data/dl20/$withrateextract --model-pipeline text2text --model-name teapotai/teapotllm --prompt-class NuggetExtractionPrompt --question-path data/dl20/dl20-nuggets.jsonl.gz  --question-type question-bank --use-nuggets  
...
python -O -m exam_pp.exam_grading_tp data/dl20/$ungraded -o data/dl20/$withrate --model-pipeline text2text --model-name teapotai/teapotllm --prompt-class QuestionSelfRatedUnanswerablePromptWithChoices --question-path data/dl20/dl20-questions.jsonl.gz  --question-type question-bank 



echo -e "\n\n\ Explained DL20 Questions"

python -O -m exam_pp.exam_grading_tp data/dl20/$withrate  -o data/dl20/$withrateextract --model-pipeline text2text --model-name teapotai/teapotllm --prompt-class QuestionCompleteConciseUnanswerablePromptWithChoices --question-path data/dl20/dl20-questions.jsonl.gz  --question-type question-bank 
