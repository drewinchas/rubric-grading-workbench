...
#SBATCH --job-name "rubric-grading-workbench-GODEL-v1_1-large-seq2seq" # job name
...
sh walkthrough-dl20_phases2thru4_GODEL-v1_1-large-seq2seq.sh 2>&1 |tee palmetto_batch_GODEL-v1_1-large-seq2seq_run.log
