...
python -O -m exam_pp.exam_grading_mpg data/dl20/$ungraded -o data/dl20/$withrate --model-pipeline text2text --model-name google/flan-t5-large --prompt-class NuggetSelfRatedPrompt --question-path data/dl20/dl20-nuggets.jsonl.gz  --question-type question-bank --use-nuggets  

echo -e "\n\n\ Explained DL20 Nuggets"

python -O -m exam_pp.exam_grading_mpg data/dl20/$withrate  -o data/dl20/$withrateextract --model-pipeline text2text --model-name google/flan-t5-large --prompt-class NuggetExtractionPrompt --question-path data/dl20/dl20-nuggets.jsonl.gz  --question-type question-bank --use-nuggets  
...
python -O -m exam_pp.exam_grading_mpg data/dl20/$ungraded -o data/dl20/$withrate --model-pipeline text2text --model-name google/flan-t5-large --prompt-class QuestionSelfRatedUnanswerablePromptWithChoices --question-path data/dl20/dl20-questions.jsonl.gz  --question-type question-bank 



echo -e "\n\n\ Explained DL20 Questions"

python -O -m exam_pp.exam_grading_mpg data/dl20/$withrate  -o data/dl20/$withrateextract --model-pipeline text2text --model-name google/flan-t5-large --prompt-class QuestionCompleteConciseUnanswerablePromptWithChoices --question-path data/dl20/dl20-questions.jsonl.gz  --question-type question-bank 
