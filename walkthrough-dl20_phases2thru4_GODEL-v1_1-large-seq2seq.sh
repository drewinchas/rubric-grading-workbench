...
#
# THIS SCRIPT ONLY INCLUDES PHASES 2 - 4!
#
...
python -O -m exam_pp.exam_grading_tp data/dl20/$ungraded -o data/dl20/$withrate --model-pipeline text2text --model-name microsoft/GODEL-v1_1-large-seq2seq --prompt-class NuggetSelfRatedPrompt --question-path data/dl20/dl20-nuggets.jsonl.gz  --question-type question-bank --use-nuggets  

echo -e "\n\n\ Explained DL20 Nuggets"

python -O -m exam_pp.exam_grading_tp data/dl20/$withrate  -o data/dl20/$withrateextract --model-pipeline text2text --model-name microsoft/GODEL-v1_1-large-seq2seq --prompt-class NuggetExtractionPrompt --question-path data/dl20/dl20-nuggets.jsonl.gz  --question-type question-bank --use-nuggets  
...
python -O -m exam_pp.exam_grading_tp data/dl20/$ungraded -o data/dl20/$withrate --model-pipeline text2text --model-name microsoft/GODEL-v1_1-large-seq2seq --prompt-class QuestionSelfRatedUnanswerablePromptWithChoices --question-path data/dl20/dl20-questions.jsonl.gz  --question-type question-bank 



echo -e "\n\n\ Explained DL20 Questions"

python -O -m exam_pp.exam_grading_tp data/dl20/$withrate  -o data/dl20/$withrateextract --model-pipeline text2text --model-name microsoft/GODEL-v1_1-large-seq2seq --prompt-class QuestionCompleteConciseUnanswerablePromptWithChoices --question-path data/dl20/dl20-questions.jsonl.gz  --question-type question-bank 
