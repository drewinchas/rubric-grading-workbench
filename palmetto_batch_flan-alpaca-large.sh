...
#SBATCH --job-name "rubric-grading-workbench-flan-alpaca-large" # job name
...
sh walkthrough-dl20_phases2thru4_flan-alpaca-large.sh 2>&1 |tee palmetto_batch_flan-alpaca-large_run.log
